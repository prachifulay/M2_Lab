 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("902905482");
		  toPrint += p1.toString("Mary Bentley");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Jee Kong");
		  toPrint += p2.toString("jkong30");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Prachi Fulay");
		  toPrint += p3.toString("pfulay3");
                  ...
                  Person5 p5 = new Person5("Shir Offsey");
                  toPrint += p5.toString("soffsey3");
